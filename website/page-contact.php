...
<meta name="description" content="Contact Don't Weight, CQC-registered weight loss clinic in London. Email hello@dontweight.co.uk or call +44 20 7101 3377. Mon-Sat support available.">
...
.phone-mobile{display:none}.phone-desktop{display:inline;cursor:pointer;color:var(--sky-deep);font-weight:600;font-size:13px}
@media(max-width:768px){.phone-mobile{display:inline}.phone-desktop{display:none}}
...
<section class="page-hero">
  ...
  <h1>Get in touch</h1>
  <p>Questions about treatment, eligibility or your account? Our team is here to help — 7 days a week.</p>
</section>
          ...
          <div class="contact-card">
            ...
            <div>
              ...
              <span class="phone-display">
                <a href="tel:+442071013377" class="phone-mobile">+44 20 7101 3377</a>
                <span class="phone-desktop" onclick="navigator.clipboard.writeText('+442071013377').then(function(){var el=document.querySelector('.phone-copied');el.style.opacity='1';setTimeout(function(){el.style.opacity='0'},1500)})">
                  +44 20 7101 3377
                  <span style="display:inline-flex;align-items:center;gap:4px;margin-left:6px;font-size:11px;color:var(--sky-deep);cursor:pointer;font-weight:600">
                  ...
                  <span class="phone-copied" style="font-size:11px;color:var(--emerald,#10b981);margin-left:6px;opacity:0;transition:opacity .3s">Copied!</span>
                </span>
              </span>
            </div>
          </div>
          <div class="contact-card">
            <div class="contact-icon" style="background:rgba(37,211,102,.15)"><svg width="20" height="20" viewBox="0 0 24 24" fill="#25d366"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg></div>
            <div>
              <h4>WhatsApp</h4>
              <p>Quick response, any time</p>
              <a href="https://wa.me/447445897994?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20weight%20loss%20treatment%20with%20Don%27t%20Weight." target="_blank" rel="noopener" style="color:#25d366">Message us on WhatsApp</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="schedule-card">
      ...
      <div style="display:flex;flex-direction:column;justify-content:center;align-items:flex-start;gap:24px">
        <p style="font-size:15px;color:rgba(255,255,255,.7);line-height:1.7;margin:0 0 8px">Use the form on the left to schedule a call, or contact us directly:</p>
        <a href="mailto:hello@dontweight.co.uk" style="display:inline-block;background:var(--sky);color:white;border:none;border-radius:100px;padding:18px 40px;font-family:var(--body);font-size:16px;font-weight:700;cursor:pointer;transition:background .2s;box-shadow:0 4px 24px rgba(56,189,248,.3);text-decoration:none"
          onmouseover="this.style.background='var(--sky-deep)'"
          onmouseout="this.style.background='var(--sky)'">
          Email us &rarr;
        </a>
        <p style="font-size:12px;color:rgba(255,255,255,.4);margin:8px 0 0">hello@dontweight.co.uk &middot; We reply within 24 hours</p>
      </div>
    </div>
  </div>
</section>
...
// Show/hide "other reason" field (only if schedule form exists on page)
var sfReasonEl=document.getElementById('sfReason');
if(sfReasonEl){sfReasonEl.addEventListener('change', function(){
  var otherField=document.getElementById('sfOtherField');
  if(otherField) otherField.style.display = this.value === 'Other — I\'ll explain below' ? 'block' : 'none';
});}
