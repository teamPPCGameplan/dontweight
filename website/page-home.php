...
<section class="faq" id="faq">
  <div class="faq-inner">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item"><button class="faq-q" onclick="togFaq(this)"><span>Should I book a health check alongside my GLP-1 treatment?</span><div class="faq-plus">+</div></button><div class="faq-a">Yes &mdash; we strongly recommend it. GLP-1 medications like Mounjaro and Wegovy are powerful drugs that change how your body processes food, stores fat, regulates blood sugar and metabolises lipids. A proper baseline health check <strong>before</strong> you start gives your clinician a clear picture of your liver, gallbladder, metabolic markers and cardiovascular function &mdash; and a structured follow-up check a few months in shows whether the medication is working well for you. It&rsquo;s the difference between medication that is prescribed and medication that is <strong>properly looked after</strong>. Our <a href="/health-checks/" style="color:var(--sky-deep);font-weight:600">Weight Loss Health Checks</a> are designed specifically for GLP-1 patients &mdash; and are also available to anyone on weight loss medication, whether you started treatment with us or elsewhere.</div></div>

      <div class="faq-item"><button class="faq-q" onclick="togFaq(this)"><span>Are weight loss health checks actually worth it?</span><div class="faq-plus">+</div></button><div class="faq-a">For anyone on GLP-1 medication, the answer is genuinely yes. Rapid weight loss increases the risk of gallstones. Fatty liver disease is common in adults who need these medications &mdash; and it can reverse on treatment, but only imaging can confirm that. Your lipids, HbA1c, kidney function and cardiovascular markers all change on GLP-1 therapy, often for the better, but your clinician cannot optimise your treatment without the data. A proper health check turns weight loss medication from a prescription into <strong>a measurable, monitored clinical programme</strong>. Our packages start at &pound;279 and are delivered by a CQC-registered private clinic &mdash; no NHS waiting list for the scans you actually need. <a href="/health-checks/" style="color:var(--sky-deep);font-weight:600">See what&rsquo;s included &rarr;</a></div></div>

      <div class="faq-item"><button class="faq-q" onclick="togFaq(this)"><span>Can I have a health check if I&rsquo;m already on Mounjaro or Wegovy from another provider?</span><div class="faq-plus">+</div></button><div class="faq-a">Absolutely. Our health checks are open to anyone taking GLP-1 medication &mdash; you don&rsquo;t need to be a Don&rsquo;t Weight treatment patient. Many people start their jab with one provider and then add clinical monitoring with us because their existing service doesn&rsquo;t include it. You keep your current prescription; we provide the clinical safety layer around it.</div></div>
    </div>
  </div>
</section>
